...
export const indiaGeoData: StateData[] = [
  {
    state: "Andhra Pradesh",
    districts: [
      "Anantapur", "Chittoor", "East Godavari", "Guntur", "Krishna", "Kurnool",
      "Nellore", "Prakasam", "Srikakulam", "Sri Potti Sriramulu Nellore",
  ...
  },
  {
    ...
    districts: [
      "Changlang", "Dibang Valley", "East Kameng", "East Siang", "Kamle",
  ...
  },
  {
    ...
    districts: [
      ...
      "Tiruvannamalai", "Tuticorin", "Vellore", "Viluppuram", "Virudhunagar"
    ]
  },
  {
    state: "Telangana",
  ...
  },
  {
    ...
    districts: [
      ...
      "Balrampur", "Banda", "Bara Banki", "Bareilly", "Basti", "Bhadohi",
  ...
  },
  {
    ...
    districts: ["Dadra", "Daman", "Diu", "Nagar Haveli"]
  },
  {
    state: "Delhi",
    districts: [
  ...
  },
  {
    ...
    districts: [
      ...
      "Jammu", "Kathua", "Kishtwar", "Kulgam", "Kupwara", "Mandoza",
...
export const getStatesList = () => indiaGeoData.map(d => d.state).sort();

export const getDistrictsOfState = (stateName: string) => {
  const match = indiaGeoData.find(d => d.state.toLowerCase() === stateName.toLowerCase());
